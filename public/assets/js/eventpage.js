...
function displayDetailArea(row) {
  ...
  **************************************/
  ...
  detailInfoEl.innerHTML = info;

  /*************************************
  find date in eventlist and update detail date
  **************************************/
  let dateListE1s = document.querySelectorAll(`#stellarEventDate${row + 1}`);
  let date = dateListE1s[0].innerHTML;
  let detailDateEl = document.querySelector("#detailDate");
  detailDateEl.innerHTML = date;
}
